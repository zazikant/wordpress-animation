...
function initTimeline() {
    ...
    if (!heroContainer || !button1 || !button2 || !button3 || !content1 || !content2 || !content3 || typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
    ...
    function setInitialState() {
        ...
        // Show only button 1, hide buttons 2 and 3
        gsap.set(button1, {
            opacity: 1,
            pointerEvents: 'auto'
        });
